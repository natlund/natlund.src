...
BLOG_AUTHOR = "Nat Lund"  # (translatable)
...
BLOG_EMAIL = "natjlund@gmail.com"
BLOG_DESCRIPTION = "Notes on mathematical physics, fractional-reserve banking, other economics, data science, etc."  # (translatable)
